...
TWITTER_USERNAME   = os.environ.get("X_USERNAME", "")
TWITTER_PASSWORD   = os.environ.get("X_PASSWORD", "")
TWITTER_HEADLESS   = os.environ.get("X_HEADLESS", "true").lower() != "false"
TWITTER_SESSION    = os.environ.get("X_SESSION", os.path.join("output", ".x_session.json"))
