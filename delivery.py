...
from config import TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID, TWITTER_USERNAME, TWITTER_PASSWORD, TWITTER_HEADLESS, log
...
REGISTRY = {
    ...
    "x": lambda cfg: _make_x(cfg),
    "console": lambda cfg: ConsoleDelivery(),
}


def _make_x(cfg):
    from delivery_x import XDelivery
    return XDelivery(
